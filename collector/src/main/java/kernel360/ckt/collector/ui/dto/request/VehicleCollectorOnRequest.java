...
public record VehicleCollectorOnRequest(
    ...
    private static final double GPS_COORDINATE_DIVISOR = 1_000_000.0;
    ...
    public VehicleCollectorOnCommand toCommand() {
        ...
        return VehicleCollectorOnCommand.create(this.mdn, this.gcd, lat, lon, this.ang, this.spd, this.sum, this.onTime);
    }
}
